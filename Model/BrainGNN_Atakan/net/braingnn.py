...
class Network(torch.nn.Module):
    ...
    def forward(self, x, edge_index, batch, edge_attr, pos):
        ...
        total = time_7 - time_1
        conv1_t = (time_2-time_1)/total
        pool1_t = (time_3-time_2)/total
        augment_t = (time_4-time_3)/total
        conv2_t = (time_5-time_4)/total
        pool2_t = (time_6-time_5)/total
        linear_t = (time_7-time_6)/total

        #print("total : {}, conv1_t : {}, pool1_t : {}, augment_t : {}, conv2_t : {}, pool2_t : {}, linear_t : {}".format(total,conv1_t,pool1_t,augment_t,conv2_t,pool2_t,linear_t))
